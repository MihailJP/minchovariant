...
preInputGlyph = {
	'u5196-03' => Kage::Glyph.new("u5196-03\t2:7:8:20:23:33:43:33:58$1:0:2:25:31:176:31$2:22:7:176:31:170:43:156:63")
}
convertGlyphList = {
	# 久
	...
	# 冖
	'u51ab'            => ['u5196-var-002',         0,   0, 200, 200],
	'u51ab-03'         => ['u5196-03-var-001',      0,   0, 200, 200],
	# 冫
	...
	# 武
	'u6b66'            => ['u6b66-itaiji-002',      0,   0, 200, 200],
	# 氵
	...
	'u7d2f-07'         => ['u7d2f-g02',      0,   0, 200, 200],
	# 言
...
# U+7247 片  U+8033 耳
# U+23D92 [淵-氵]
ignorePattern = /^(u(4e31|4ee5|53d6|53e2|5de5|5f0f|6b6f|7247|8033|23d92)|j90-4c6c|u2ff1-cdp-8cfa-u5bf8)($|-|@\d+)/
