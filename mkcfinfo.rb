...
GlyphList = {
	...
	"Enclosed" => [
		(7555..7574).to_a, (7613..7617).to_a, 8091, (8102..8111).to_a, (8152..8165).to_a,
		(8152..8165).to_a, 8191, 8223, 8224, (8286..8294).to_a, (8317..8320).to_a, (10234..10501).to_a,
		(10503..10763).to_a, 16328, 20505, 20553
		].flatten
}
